...
namespace Maticsoft.DAL
{
	...
	public partial class Comment
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.Comment model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Comment(");
			strSql.Append("NewsID,AuthorID,Adddate,Contents,Status,Remark)");
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.Comment GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,NewsID,AuthorID,Adddate,Contents,Status,Remark from Comment ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,NewsID,AuthorID,Adddate,Contents,Status,Remark ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,NewsID,AuthorID,Adddate,Contents,Status,Remark ");
			strSql.Append(" FROM Comment ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
